...
class Simulator(BaseSimulator):
    ...
    def __init__(self, interactive, try_use_sim, f):
        ...
        if self.with_pyrep:
            ...
            self._vision_sensor_0.set_position(np.array([1.35, -0.05, 1.95]))
            self._vision_sensor_0.set_orientation(np.array([-145.81*np.pi/180, -27.763*np.pi/180, 136.5*np.pi/180]))
            self._vision_sensor_1.set_perspective_angle(60)
            self._vision_sensor_1.set_resolution([1024, 1024])
            self._vision_sensor_1.set_position(np.array([1.65, -2.075, 0.875]))
            self._vision_sensor_1.set_orientation(np.array([-91.181*np.pi/180, -30.478*np.pi/180, -171.39*np.pi/180]))
            self._vision_sensor_2.set_perspective_angle(60)
            self._vision_sensor_2.set_resolution([1024, 1024])
            self._vision_sensor_2.set_position(np.array([-0.94, -1.71, 0.994]))
            self._vision_sensor_2.set_orientation(np.array([-116.22*np.pi/180, 39.028*np.pi/180, -138.88*np.pi/180]))

            self._vision_sensor_3.set_perspective_angle(60)
            self._vision_sensor_3.set_resolution([512, 512])
            self._vision_sensor_3.set_position(np.array([0.35, -2.05, 0.68]))
            self._vision_sensor_3.set_orientation(np.array([-90.248*np.pi/180, -1.2555*np.pi/180, -179.88*np.pi/180]))
