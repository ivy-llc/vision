.. image:: https://github.com/unifyai/unifyai.github.io/blob/master/img/externally_linked/repos/vision/logo.png?raw=true
   :width: 100%
...
.. raw:: html
    ...
    <a href="https://github.com/unifyai/vision/actions?query=workflow%3Adocs">
        <img style="float: left; padding-right: 4px; padding-bottom: 4px;" src="https://img.shields.io/github/workflow/status/unifyai/vision/docs?label=docs">
    </a>
    <a href="https://github.com/unifyai/vision/actions?query=workflow%3Anightly-tests">
        <img style="float: left; padding-right: 4px; padding-bottom: 4px;" src="https://img.shields.io/github/workflow/status/unifyai/vision/nightly-tests?label=tests">
    </a>
...
.. code-block:: python
    ...
    import ivy
    from ivy.backend_handler import choose_random_backend
    ivy.set_backend(choose_random_backend())
