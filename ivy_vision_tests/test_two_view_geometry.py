...
def test_pixel_to_pixel_coords(device, call):
...
def test_angular_pixel_to_angular_pixel_coords(device, call):
...
def test_cam_to_cam_coords(device, call):
...
def test_sphere_to_sphere_coords(device, call):
...
def test_get_fundamental_matrix(device, call):
...
def test_closest_mutual_points_along_two_skew_rays(device, call):
...
def test_triangulate_depth_by_closest_mutual_points(device, call):
...
def test_triangulate_depth_by_homogeneous_dlt(device, call):
