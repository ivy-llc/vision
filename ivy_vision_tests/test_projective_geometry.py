...
def test_transform(device, call):
...
def test_projection_matrix_pseudo_inverse(device, call):
...
def test_projection_matrix_inverse(device, call):
...
def test_solve_homogeneous_dlt(device, call):
