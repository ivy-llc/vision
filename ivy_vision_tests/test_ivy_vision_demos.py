...
@pytest.mark.parametrize(
    "with_sim", [False])
def test_demo_coords_to_voxel_grid(with_sim, device, f, call, fw):
...
@pytest.mark.parametrize(
    "with_sim", [False])
def test_demo_render_image(with_sim, device, f, call, fw):
...
@pytest.mark.parametrize(
    "with_sim", [False])
def test_demo_nerf(with_sim, device, f, call, fw):
